...
class CoordinatesDS:
    ...
    def __init__(self, direction):
        ...
        self._prev = "front"  # Imposta la direzione iniziale
        self._id = 0

    def set_direction(self, direction):
        self._prev = self._direction
        self._direction = direction

    def save_crossroad(self):
        crossroads.append({self._id, (self._x, self._y)})
        self._id += 1

    def moving(self):
        angle = math.degrees(normalize_angle(get_robot_orientation()))

        # Definizione degli intervalli di angoli normalizzati
...
if __name__ == "__main__":
    ...
    try:
        while True:
            coordinates.moving()
            print(coordinates._x, coordinates._y, coordinates._direction, coordinates._prev)
