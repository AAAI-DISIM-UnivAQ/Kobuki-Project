...
def detect_crossroad(image):
    pass


def capture_and_display_video(sim, handle, robot_handle, stop_distance, max_correction):
    sim.startSimulation()
...
capture_and_display_video(sim, vision_sensor_handle,
                          robot_handle, stop_distance, max_correction)
